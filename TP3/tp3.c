...
int main(void){
  ...
  EcrSMD(fic_smd, nbtng, SecMembre, NumDLDir, ValDLDir, AdPrCoefLi, Matrice, NumCol, AdSuccLi);  

  LecSMD(fic_smd, &nbtng, &SecMembre, &NumDLDir, &ValDLDir, &AdPrCoefLi, &Matrice, &NumCol, &AdSuccLi);
